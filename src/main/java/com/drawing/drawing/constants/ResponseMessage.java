package com.drawing.drawing.constants;
...
public class ResponseMessage {
    ...
    public static final String READ_USER_INFO_SUCCESS = "유저 정보 확인 성공";
    ...
    public static final String DELETE_DRAWING = "피드백 요청 삭제 성공";
    ...
    public static final String READ_ACCEPTED_FEEDBACK = "접수 상태 피드백 목록 조회 성공";
